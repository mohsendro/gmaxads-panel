                                    ...
                                    <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/index.html" class="menu-link active">
                                                        ...
                                                        <span class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-7 fw-semibold text-muted">گزارشات و
                                                                آمارها</span>
                                                        </span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/projects.html"
                                                        ...
                                                        <span class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-7 fw-semibold text-muted">گراف ها و
                                                                نمودارها</span>
                                                        </span>
                                                    </a>
                                                    <!--end:Menu link-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/online-courses.html"
                                                        ...
                                                        <span class="d-flex flex-column">
                                                            <span class="fs-6 fw-bold text-gray-800">آنلاین دوره
                                                                ها</span>
                                                            <span class="fs-7 fw-semibold text-muted">پیشرفت دانش
                                                                آموز</span>
                                                        </span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="../../demo1/dist/dashboards/marketing.html"
                                                        ...
                                                        <span class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-7 fw-semibold text-muted">کمپین ها و تبدیل
                                                                ها</span>
                                                        </span>
                                                    </a>
                                                    <!--end:Menu link-->
                                        ...
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                            <div class="d-flex flex-column me-5">
                                                ...
                                                <div class="fs-7 fw-semibold text-muted">تک صفحه فرود نمونه با قیمت
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">سوالات متداول
                                                            </h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="../../demo1/dist/pages/faq/classic.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">سوالات متداول
                                                                        کلاسیک</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="../../demo1/dist/pages/faq/extended.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">سوالات متداول تمدید
                                                                        شده</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">شبکه اجتماعی
                                                            </h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">عمومی مودال ها
                                                            </h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">پیشرفته مودال ها
                                                            </h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <!--begin:Heading-->
                                                <h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">قالب
                                                    بندی ها</h4>
                                                <!--end:Heading-->
                                                <!--begin:Menu item-->
                                                <div class="menu-item p-0 m-0">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <!--begin:Heading-->
                                                <h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">نوار
                                                    ابزار</h4>
                                                <!--end:Heading-->
                                                <!--begin:Menu item-->
                                                <div class="menu-item p-0 m-0">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column me-5">
                                                ...
                                                <div class="fs-7 fw-semibold text-muted">سفارشی کردن، نمایش و صادرات
                                                </div>
                                            </div>
                            ...
                            <form data-kt-search-element="preferences" class="pt-1 d-none">
                                ...
                                <div class="pb-4 border-bottom">
                                    <label
                                        ...
                                        <span class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">پروژه
                                            ها</span>
                                ...
                                <div class="py-4 border-bottom">
                                    <label
                                        class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                        <span
                                            class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">اهداف</span>
                                        <input class="form-check-input" type="checkbox" value="1"
                                            checked="checked" />
                                    </label>
                                </div>
                                ...
                                <div class="py-4 border-bottom">
                                    <label
                                        class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                        <span class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">برنامه
                                            بازاریابی</span>
                                        <input class="form-check-input" type="checkbox" value="1" />
                                    </label>
                                </div>
                                ...
                                <div class="py-4 border-bottom">
                                    <label
                                        class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                        <span
                                            class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">مراجعات</span>
                                        <input class="form-check-input" type="checkbox" value="1"
                                            checked="checked" />
                                    </label>
                                </div>
                                ...
                                <div class="py-4 border-bottom">
                                    <label
                                        class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                        <span
                                            class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">کاربران</span>
                                        <input class="form-check-input" type="checkbox" value="1" />
                                    </label>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="d-flex justify-content-end pt-7">
                                    ...
                                    <button type="submit" class="btn btn-sm fw-bold btn-primary">ذخیره
                                        تغییرات</button>
                                </div>
                                <!--end::Actions-->
                            </form>
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold">پروژه
                                                    بریفینگ</a>
                                                <div class="text-gray-400 fs-7">به روز رسانی وضعیت راه اندازی محصول
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold">دارایی های
                                                    بنر</a>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold">نماد دارایی
                                                    ها</a>
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <div class="text-center text-gray-600 fw-semibold pt-1">رئوس مطالب شما را صادق
                                            نگه می دارد. آنها جلوی شگفت انگیز بودن شما درمورد رانندگی را می گیرند</div>
                                        <!--end::Text-->
                                        <!--begin::Actions-->
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">سفارش جدید</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">مشتری جدید</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">پردازش درگاه</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">جستجوی کوئری</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">ارتباط کلید
                                                دسترسی</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">بازیابی
                                                دیتابیس</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">بروزرسانی
                                                سیستم</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">اپدیت سیستم عامل
                                                سرور</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">برگشت کلید
                                                دسترسی</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">روند
                                                بازپرداخت</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">روند برداشت</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fw-semibold">وظایف نامه</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::بخش-->
                                        <!--begin::Tags-->
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">درگاه
                                                ها</div>
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Menu item-->
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">جلالی
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">حرفه
                                            ای</span>
                                    </div>
                                    <a href="#"
